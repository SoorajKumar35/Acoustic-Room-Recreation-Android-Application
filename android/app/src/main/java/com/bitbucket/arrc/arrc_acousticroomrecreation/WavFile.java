...
public class WavFile
{
	...
	public static WavFile openWavFile(AssetFileDescriptor file) throws IOException, WavFileException
	{
		...
		while (true)
		{
			...
			if (chunkID == FMT_CHUNK_ID)
			{
				...
				if (wavFile.bytesPerSample * wavFile.numChannels != wavFile.blockAlign) {
					Log.e("WAV_FILE", Integer.toString(wavFile.bytesPerSample));
					Log.e("WAV_FILE", Integer.toString(wavFile.numChannels));
					Log.e("WAV_FILE", Integer.toString(wavFile.blockAlign));
